    ...
    property $ do
        (rga0, rga1, rga2) <-
            ...
            runExceptT $ do
                ...
                pure (rga0, rga1, rga2)
        prep rga0 ===
            [   [ "*rga", "#B/0000000006+000000003f", "@B/0000000005+000000003f"
                , ":0", "!" ]
            ,   ["@B/0000000001+000000003f", ":0", "'h'", ","]
            ,   ["@B/0000000002+000000003f", ":0", "'e'", ","]
            ,   ["@B/0000000003+000000003f", ":0", "'l'", ","]
            ,   ["@B/0000000004+000000003f", ":0", "'l'", ","]
            ,   ["@B/0000000005+000000003f", ":0", "'o'", ","]
            ,   ["."]
            ]
        prep rga1 ===
            [   [ "*rga", "#B/0000000006+000000003f", "@B/0000000007+000000003f"
                , ":0", "!" ]
            ,   ["@B/0000000001+000000003f", ":0", "'h'", ","]
            ,   ["@B/0000000002+000000003f", ":0", "'e'", ","]
            ,   ["@B/0000000003+000000003f", ":0", "'l'", ","]
            ,   ["@B/0000000004+000000003f", ":0", "'l'", ","]
            ,   [ "@B/0000000005+000000003f", ":B/0000000007+000000003f", "'o'"
                , "," ]
            ,   ["."]
            ]
        prep rga2 ===
            [   [ "*rga", "#B/0000000006+000000003f", "@B/0000000009+000000003f"
                , ":0", "!" ]
            ,   ["@B/0000000001+000000003f", ":0", "'h'", ","]
            ,   ["@B/0000000002+000000003f", ":0", "'e'", ","]
            ,   ["@B/0000000003+000000003f", ":0", "'l'", ","]
            ,   [ "@B/0000000004+000000003f", ":B/0000000008+000000003f", "'l'"
                , "," ]
            ,   [ "@B/0000000005+000000003f", ":B/0000000007+000000003f", "'o'"
                , "," ]
            ,   ["@B/0000000009+000000003f", ":0", "'p'", ","]
            ,   ["."]
            ]
